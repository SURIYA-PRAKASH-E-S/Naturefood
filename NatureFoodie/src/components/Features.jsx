      ...
      <div className="px-4 py-5 mx-auto my-10 max-w-7xl sm:px-6 lg:px-8">
         <div className="max-w-xl mx-auto text-center">
            <h2 className="mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">
               Nature-Food helps you find
               <span className="font-serif text-green"> Healthy </span>
               Food
            </h2>
            <p className="mt-4 text-base leading-relaxed text-gray-600">
               Discover, and elevate your wonderful experience with Nature-Food
               . We're not just helping you find Nature food; we're
               making it even better. Join us for a fruitful journey like no
               other.
            </p>
         </div>
         <div className="grid grid-cols-1 p-4 mt-12 mb-6 text-center shadow-xl gap-y-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 rounded-2xl bg-gray">
            ...
            <div>
               ...
               <p className="mt-4 text-sm text-gray-600">
                  Filter your food
                  preferences for a personalized Good experience that
                  delights
               </p>
            </div>
         </div>
